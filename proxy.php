 ...
 * index.html এর পাশেই একই ফোল্ডারে রাখুন।
 * API key + সব মুডের সিস্টেম প্রম্পট শুধু এখানে থাকবে (সার্ভারে)।
 */
...
// ================= আপনার তথ্য =================
// 🔑 নতুন API key এখানে বসান (Google AI Studio থেকে বানানো)
$GEMINI_KEY = 'AQ.Ab8RN6LjveJcgLCsLFdQAJY93iiFbHRgPTeSrVVGMwQr3eyr0Q';

// মডেল (চাইলে বদলাতে পারেন)
$MODEL = 'gemini-2.0-flash';

// ================= Riya-র প্রম্পট (শুধু সার্ভারে) =================
$PROMPTS = array(
...
$payload = array(
  ...
  'generationConfig' => array('temperature' => $temp, 'maxOutputTokens' => $tokens, 'topP' => 0.95)
);
